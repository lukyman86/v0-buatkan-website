...
export default function MemberArea() {
  ...
  const handleTestNotification = () => {
    addNotification({
      ...
      message: "Ini adalah contoh notifikasi yang baru saja dibuat.",
      type: "info",
    })
  }
          ...
          <div className="flex flex-col gap-6">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
              ...
              <div className="flex gap-2">
                <Button variant="outline" size="sm" className="h-9" onClick={handleTestNotification}>
                ...
                <Card>
                  ...
                  <CardContent>
                    ...
                    <div className="mt-6 space-y-4">
                      ...
                      <div className="pt-2">
                        <Button className="w-full bg-green-600 hover:bg-green-700">Undang Member Baru</Button>
                      </div>
                    </div>
                  </CardContent>
                </Card>
